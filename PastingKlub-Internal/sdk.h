...
public:
	...
	AWeapon* CurrentWeapon() {
		if (!sdkUssage->isValidPointer((uintptr_t)this)) return 0;
		return (AWeapon*)(*(uintptr_t*)((uintptr_t)this + 0x8f0)); //FortPawn::CurrentWeapon 0x868
	}
...
public:
	...
	{
		auto subIsVisible = reinterpret_cast<bool(__fastcall*)(APlayerController * PlayerController, AFortPawn * Pawn, Vector3 * ViewPoint)>(LineOfSightTo);
